...
class ConfigReader:
    def __init__(self, config_file=None):
        config_file = config_file or os.getenv("ULTRAAIMER_CONFIG")
        config_file = Path(config_file) if config_file else Path(__file__).with_name("config.ini")
    ...
    def get_com_config(self):
        return {"COM_port": self.config.get("COM", "COM_port"), "Bauldrate": self.config.getint("COM", "Bauldrate")}
    ...
    def get_debug_config(self):
        return {"enabled": self.config.getboolean("debug", "enabled")}
